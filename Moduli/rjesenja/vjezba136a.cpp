...
void init() {
	...
	timer1OC1AEnableNonInvertedPWM();	// neinvertirajuci PWM pin OC1A
	timer1OC1BEnableNonInvertedPWM();	// neinvertirajuci PWM pin OC1B
	timer2OC2AEnableNonInvertedPWM();	// neinvertirajuci PWM pin OC2A
